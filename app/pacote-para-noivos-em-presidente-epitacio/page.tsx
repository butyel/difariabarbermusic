...
import { Sparkles, Heart, Clock, Star, DollarSign, Shield, Scissors, ArrowRight, Diamond } from "lucide-react";
...
const trackingMessage = "Olá, encontrei a DiFaria pela página de pacote para noivos e gostaria de consultar os horários disponíveis.";
    ...
    <main>
      ...
      <section className="section section-dark">
        <div className="container" style={{ textAlign: "center" }}>
          ...
          <AnimateIn variant="fade-up" delay={200}>
            <div className="pricing-cards" style={{ marginTop: 28 }}>
              <div className="pricing-card">
                ...
                <p className="pricing-card-label">Duração (dia)</p>
                <p className="pricing-card-value">90 min</p>
              </div>
              <div className="pricing-card">
                <DollarSign aria-hidden="true" className="pricing-card-icon" size={28} />
                <p className="pricing-card-label">Pacote completo</p>
          ...
          <Testimonials testimonials={TESTIMONIALS["pacote-para-noivos"]} variant="cream" />
